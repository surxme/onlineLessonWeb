...
function hideMessage(a) {
    $(".waifu-tips").stop().css("opacity", 0.5);
    void 0 === a && (a = 5E3);
...
function loadTipsMessage(a) {
    ...
    function k() {
        switch (live2d_settings.hitokotoAPI) {
            case "lwl12.com":
                $.getJSON("https://api.lwl12.com/hitokoto/v1?encode=realjson",
                    function(a) {
                        if (!empty(a.source)) {
    ...
    $.each(a.mouseover,
        function(a, b) {
            $(document).on("mouseover", b.selector,
                function() {
    ...
    live2d_settings.showCopyMessage && $(document).on("copy",
        function() {
...
live2d_settings.tipsMessage = "__STATIC__/js/waifu-tips.json";
...
live2d_settings.waifuSize = "120x120";
live2d_settings.waifuTipsSize = "70x70";
...
live2d_settings.waifuMinWidth = "120px";
